      ...
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <p className="mt-2 text-sm text-gray-500 px-4">Your Daily Nutrition</p>
          </div>
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <Link href={'/women'} className="text-gray-600 hover:text-gray-800">Women's</Link>
                </li>
                <li>
                  <Link href={'/mens'} className="text-gray-600 hover:text-gray-800">Men's</Link>
                </li>
                <li>
                  <Link href={'/energyballs'} className="text-gray-600 hover:text-gray-800">Energy Balls</Link>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <Link href={'/articles'} className="text-gray-600 hover:text-gray-800">Blogs</Link>
                </li>
                <li>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Nittya — All Right Reserved
              <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@nittya</a>
            </p>
